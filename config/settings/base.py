...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://postgres:123456@127.0.0.1:5432/sisgef",
    ),
}
...
MIGRATION_MODULES = {"sites": "sisgef.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "sisgef.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Raphael Muniz""", "raphael.muniz@ifrn.edu.br")]
...
ACCOUNT_FORMS = {"signup": "sisgef.users.forms.UserSignupForm"}
